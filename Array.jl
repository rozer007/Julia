...
a2 = Array{Int32}(undef, (2,2))
println(a2)

# Or like this
a3 = Float64[0,1,2,3,4,5]
println(a3)
...
println( 5 in a4)
println(isequal(4,4))
println(findfirst(isequal(4),a4))
 
# Find all matches using a generic function
f(a) = (a >= 2) ? true : false
println(findall(f, a4))
println(count(f, a4))
println(size(a4)) #get rows and column
